...
public class TileRes extends TileAndy {
	private final JLabel lblRes1, lblRes2;
	...
	@Override
	public void setType(final TileEnum tileType) {
	...
	public void setRes(final ResourceCubeType resType, final boolean blnTwoRes) {
